...
app.post('/notify', async (req, res) => {
    ...
    if (!userId || !message) {
        ...
        (0, logging_middleware_1.Log)("backend", "warn", "handler", "Missing user ID or message in notification request.");
    ...
    (0, logging_middleware_1.Log)("backend", "info", "api", `Dispatching notification to user ${userId}`);
    await new Promise(resolve => setTimeout(resolve, 300));
...
app.listen(PORT, () => {
    ...
    (0, logging_middleware_1.Log)("backend", "info", "config", "Notification Application Started");
});
